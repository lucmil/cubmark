...
#ifndef CUBMARK_FULLVIEWBUILDER_H
#define CUBMARK_FULLVIEWBUILDER_H
...
private:
	 ...
	 * whichever is larger
	 */
	static const int fieldWidths[15];

	/** \brief Field titles
	 */
	static const char *fieldTitles[15];

	static const double factors[15];
};

}

#endif//CUBMARK_FULLVIEWBUILDER_H
